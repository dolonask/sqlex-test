...
import kg.megacom.sqlextest.models.pojo.Task1View;
import kg.megacom.sqlextest.models.pojo.Task7View;
...
public interface PCRepository extends JpaRepository<Pc, Integer> {
    ...
    @Query("select new kg.megacom.sqlextest.models.pojo.Task1(u.product.model, u.speed, u.hd) from Pc u where u.price < ?1")
